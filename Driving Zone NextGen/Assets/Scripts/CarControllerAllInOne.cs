...
public class CarControllerAllInOne : MonoBehaviour
{
    //CAR SETUP
    ...
    */
    ...
    void Start()
    {
        ...
        //	InvokeRepeating("CarSpeedUI", 0f, 0.5f); // velocity changes every 0.5 sec
        //}
        //else if (!useUI)
        //{
    ...
    void Update()
    {
        ...
        */
        ...
        else
        {
            ...
            if (!(Input.GetKey(KeyCode.UpArrow) || Input.GetKey(KeyCode.W) || Input.GetKey(KeyCode.DownArrow) || Input.GetKey(KeyCode.S) || Input.GetKey(KeyCode.Space) || deceleratingCar))
            {
                InvokeRepeating("DecelerateCar", 0f, 0.1f);
                deceleratingCar = true;
            }
    ...
    public void TurnLeft()
    {
        ...
        frontLeftCollider.steerAngle = ackermanCoef * Mathf.Lerp(frontLeftCollider.steerAngle, steeringAngle, steeringSpeed);
    ...
    public void TurnRight()
    {
        ...
        frontRightCollider.steerAngle = ackermanCoef * Mathf.Lerp(frontRightCollider.steerAngle, steeringAngle, steeringSpeed);
    }
